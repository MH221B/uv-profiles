...
The automated harness also covers explicit path passthrough, `.venv`, leading-dash and help targets, option-first calls, PowerShell 5.1 `--` behavior, invalid plain names, native failure codes, reruns, missing-uv behavior, and preservation of active-profile state.
